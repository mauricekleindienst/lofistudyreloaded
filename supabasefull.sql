...
CREATE TABLE public.user_pomodoros (
  email character varying NOT NULL,
  ...
  user_id uuid,
  CONSTRAINT user_pomodoros_pkey PRIMARY KEY (email),
  CONSTRAINT user_pomodoros_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
