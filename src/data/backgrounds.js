...
exports.DEFAULT_BACKGROUND = exports.backgrounds = void 0;
// Helper function to create background object
var createBackground = function (id, filename, alt, note, createdby, priority, category) {
    return {
        id: id,
        src: "https://lofistudy.fra1.cdn.digitaloceanspaces.com/backgrounds/".concat(filename),
        filename: filename,
        alt: alt,
        note: note,
        createdby: createdby,
...
exports.DEFAULT_BACKGROUND = exports.backgrounds[0]; // Rain background with high priority
